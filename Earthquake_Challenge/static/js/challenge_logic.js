...
// We create the sixth tile layer that will be the background of our map.
...
// We create a fourth tile layer that will be the background of our map.
...
// We create a fifth tile layer that will be the background of our map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(platedata) {
      // Add data and styling to tectonicPlates - color and weight to stand out against all maps (red)
      L.geoJson(platedata, {
        color: "red",
        weight: 3
      })
